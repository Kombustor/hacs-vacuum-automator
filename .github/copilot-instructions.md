...
- **Main code:** `custom_components/vacuum_scheduler/`
...
- `entity/` — Base entity class (`VacuumSchedulerEntity`)
...
- Entity MRO: `(PlatformEntity, VacuumSchedulerEntity)` — order matters
...
- Debug level: `custom_components.vacuum_scheduler: debug` in `config/configuration.yaml`
