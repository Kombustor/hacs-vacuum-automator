"""Sensor platform for vacuum_scheduler."""
...
from .air_quality import ENTITY_DESCRIPTIONS as AIR_QUALITY_DESCRIPTIONS, VacuumSchedulerAirQualitySensor
from .diagnostic import ENTITY_DESCRIPTIONS as DIAGNOSTIC_DESCRIPTIONS, VacuumSchedulerDiagnosticSensor
...
async def async_setup_entry(
    ...
    async_add_entities(
        VacuumSchedulerAirQualitySensor(
    ...
    async_add_entities(
        VacuumSchedulerDiagnosticSensor(
            coordinator=entry.runtime_data.coordinator,
            entity_description=entity_description,
        )
