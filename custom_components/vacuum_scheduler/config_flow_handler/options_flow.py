"""
Options flow for vacuum_scheduler.
...
from custom_components.vacuum_scheduler.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class VacuumSchedulerOptionsFlow(config_entries.OptionsFlow):
    """
...
__all__ = ["VacuumSchedulerOptionsFlow"]
