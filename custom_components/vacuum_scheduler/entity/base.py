"""
Base entity class for vacuum_scheduler.
...
from custom_components.vacuum_scheduler.const import ATTRIBUTION
...
class VacuumSchedulerEntity(CoordinatorEntity[VacuumSchedulerDataUpdateCoordinator]):
    """
    Base entity class for vacuum_scheduler.
