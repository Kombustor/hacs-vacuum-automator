"""Device info utilities for vacuum_scheduler."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Vacuum Scheduler",
        manufacturer=manufacturer or "Vacuum Scheduler",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('vacuum_scheduler', 'entry_id_value')}
    """
