"""Target humidity number for vacuum_scheduler."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.vacuum_scheduler.api import VacuumSchedulerApiClientError
from custom_components.vacuum_scheduler.const import LOGGER
from custom_components.vacuum_scheduler.entity import VacuumSchedulerEntity
from homeassistant.components.number import NumberDeviceClass, NumberEntity, NumberEntityDescription, NumberMode
from homeassistant.const import PERCENTAGE
from homeassistant.exceptions import HomeAssistantError

if TYPE_CHECKING:
    from custom_components.vacuum_scheduler.coordinator import VacuumSchedulerDataUpdateCoordinator
...
class VacuumSchedulerHumidityNumber(NumberEntity, VacuumSchedulerEntity):
    """Target humidity number class."""

    def __init__(
        self,
        coordinator: VacuumSchedulerDataUpdateCoordinator,
