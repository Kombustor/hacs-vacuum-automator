"""
Custom integration to integrate vacuum_scheduler with Home Assistant.
...
https://github.com/Kombustor/hacs-vacuum-automator
...
from .data import VacuumSchedulerData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import VacuumSchedulerConfigEntry
